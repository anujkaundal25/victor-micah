...
function Blog() {
  const blogList = [
    ...
    },
    {
      ...
      description:
        "SaaS development is the process of building software that people access online instead of installing on a local device. It powers everything from project management tools and CRMs to AI platforms, internal systems, and customer-",
      date: "20",
      month: "Aug",
      image:
    ...
    },
    {
      ...
      description:
        "Enterprise software is the backbone of modern organizations. It helps companies manage operations, connect teams, improve visibility, and scale without turning every process into manual work. For growing businesses,",
      date: "20",
      month: "Aug",
      image:
    ...
    },
     {
      ...
      description:
        "AI software development is changing how modern businesses build products, automate work, and serve customers. Instead of treating software as a static tool, companies are now",
      date: "20",
      month: "Aug",
      image:
        "https://i0.wp.com/novarisstudio.com/wp-content/uploads/2026/05/Novaris_ai-software-dev_blog_image_updated.jpg?fit=1254%2C1254&ssl=1",
    },
  ];
